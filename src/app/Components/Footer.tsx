...
const Footer = () => {
  return (
    <div className="bg-green-100 md:rounded-tl-[260px]">
    <div className=" text-gray-700 py-8 container mx-auto">
      <div className="mx-auto max-w-7xl px-4 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-5 mt-8">
            ...
            <ul className="space-y-2">
              {footerData.services.map((service, index) => (
                <li key={index} className="flex items-center">
                  <FaAngleRight className="text-gray-800 mr-2" />
                  <Link
                    href={service.path}
          ...
          {/* Offering */}
          {/* <div>
            <h1 className="text-xl font-semibold text-gray-800 mb-4">Offering</h1>
            <ul className="space-y-2">
          ...
          {/* Address & Contact */}
          <div>
            <h1 className="text-xl font-semibold text-gray-800 mb-4">Address</h1>
            <div className="space-y-2">
              <div className="flex items-center">
                <FaLocationDot className="text-gray-800 mr-2" />
                <p>{footerData.contact.address}</p>
              </div>
              <div className="flex items-center">
                <MdAccessTimeFilled className="text-gray-800 mr-2 text-xl" />
                <p>{footerData.contact.workingHours}</p>
              </div>
              <div className="flex items-center">
                <IoCall className="text-gray-800 mr-2" />
                <Link
              ...
              <div className="flex items-center">
                <IoIosMailUnread className="text-gray-800 mr-2" />
                <Link
        ...
        <div className="border-t border-gray-500 mt-8 pt-6 text-center text-gray-600">
